...
Code, benchmarks and results presented in this section are available at the following address: \url{https://github.com/coast-team/mute-bot-random/}.
...
It is necessary to take this into account when designing the strategy used to trigger \emph{rename} operations in order to minimise their impact on the user experience, as they prevent the integration of other updates during this period.
Further work is also needed to improve the performance of the operation.
