...
\begin{enumerate*}
    \item It reuses the id of the first element of the sequence, but modified with the node id and sequence number (\autoref{fig:renaming-first-id})
...
Upon the reception of an operation, nodes compare the epoch of the operation to their current one.
